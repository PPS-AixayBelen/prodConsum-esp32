...
void *run(cpuProcess_o *cpuProcess)
{
    ...
    if (DEBUG)
        Serial.print("VOY A DISPARAR: %d y soy el hilo con id %d\n", cpuProcess->processList[0], cpuProcess->id);
    // sleep(1);
    int shootResult = 0;
    while (1)
    {
